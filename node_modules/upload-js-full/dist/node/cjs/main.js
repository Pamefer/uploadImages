  ...
  ChunkedStream_createClass(ChunkedStream, [{
    ...
    value: function createStream() {
      try {
        ...
        return ChunkedStream_await(Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, "stream", 23)), function (_import) {
  ...
  UploadManager_createClass(UploadManager, [{
    ...
    value: function nodeJsBlob(data) {
      try {
        ...
        return UploadManager_await(Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, "buffer", 23)), function (_import) {
