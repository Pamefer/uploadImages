...
/******/ !function() {
/******/ 	var inProgress = {};
/******/ 	var dataWebpackPrefix = "upload-js-full:";
...
/******/ 	}
/******/ 	
/******/ 	var chunkLoadingGlobal = self["webpackChunkupload_js_full"] = self["webpackChunkupload_js_full"] || [];
  ...
  ChunkedStream_createClass(ChunkedStream, [{
    ...
    value: function createStream() {
      try {
        ...
        return ChunkedStream_await(Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, "?9d47", 23)), function (_import) {
...
var stream_ignored_ = __webpack_require__("?9d47");
...
var UploadManager = /*#__PURE__*/function () {
  ...
  UploadManager_createClass(UploadManager, [{
    ...
    value: function bufferToStream(buffer) {
      var readable = new stream_ignored_.Readable();
      readable._read = function () {}; // _read is required but you can noop it
    ...
    value: function nodeJsBlob(data) {
      try {
        ...
        return UploadManager_await(__webpack_require__.e(/* import() */ "_96d8").then(__webpack_require__.t.bind(__webpack_require__, "?96d8", 23)), function (_import) {
